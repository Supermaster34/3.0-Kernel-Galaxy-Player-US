...
make -j4 CROSS_COMPILE=arm-eabi- ARCH=arm yp_g70_usa_defconfig
# get rid of the damn + after the version
export LOCALVERSION=""
export KBUILD_BUILD_HOST="ThinkPad-X220"
export KBUILD_BUILD_USER="JackpotClavin"
make -j4 CROSS_COMPILE=arm-eabi- ARCH=arm && cp -a $(find . -name *.ko -print |grep -v initramfs) kernel/usr/initramfs/lib/modules/ && make -j4 CROSS_COMPILE=arm-eabi- ARCH=arm
